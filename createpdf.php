...
#$stringData = "This is an automatically generated PDF file containing data gathered from Administrator\n";
#fwrite($fh, $stringData);
#$stringData = "#NP\n";
#fwrite($fh, $stringData);
##$stringData = "1<Graphs>\n";
...
$pdf->addText(50,34,6,'Generated by winstol2yLab test Report v1.0');
$pdf->restoreState();
$pdf->closeObject();
...
$pdf->ezText("$company_name Report",40,array('justification'=>'centre'));
